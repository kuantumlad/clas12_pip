...
public class BResPPion {

    int run_number = -1;
    String s_run = "";
    public BResPPion( int temp_run ){
	run_number = temp_run;
    ...
    H2F h2_rc_pp_betap;
    H1F h_rc_pp_beta_res;


    public void createResPPionHistograms(){

 	////////////////////////////////////////////////////////////////////
	//BETA STUDY
	h_rc_pp_beta_res = new H1F("h_rc_pp_beta_res","h_rc_pp_beta_res", 200, -0.05, 0.05 );
	h2_rc_pp_betap = new H2F("h2_rc_pp_betap","h2_rc_pp_betap", 100, 0.4, 5.5, 100, -0.04, 0.04);
 
    }

    public void saveResPPion(){


    }


    public void sliceNFitResPPion() {
	...
	H2F h2_temp_rebinX = h2_rc_pp_betap.rebinY(5);
	H2F h2_temp_rebinXY = h2_rc_pp_betap.rebinX(5);
	...
	g_mean.setTitle(" MEAN BETA FOR PION PLUS ");
	g_sigmas.setTitle(" MEAN BETA FOR PION PLUS ");
	...
	c_slices.save("/lustre/expphy/work/hallb/clas12/bclary/pics/pid_clary/h_pp_resbeta_slices_allsector.png"); 
	c_betap_fit.save("/lustre/expphy/work/hallb/clas12/bclary/pics/pid_clary/g_pp_resbeta_fit_allsector.png"); 


    }


    public void histoResPPionToHipo(){
	
	dir.mkdir("/res_pos_betap/");
	dir.cd("/res_pos_betap/");
	dir.addDataSet(h2_rc_pp_betap);

	dir.addDataSet(h_rc_pp_beta_res);
	EmbeddedCanvas c_pp_res = new EmbeddedCanvas();
	c_pp_res.setSize(900,900);
	System.out.println(" >> FITTING BETA RESOLUTION HISTOGRAM " );
	F1D f_beta_res = Calculator.fitHistogram(h_rc_pp_beta_res,0.6);
	...
	c_pp_res.draw(h_rc_pp_beta_res,"same");
	c_pp_res.draw(f_beta_res,"same");
	c_pp_res.save("/lustre/expphy/work/hallb/clas12/bclary/pics/pid_clary/h_rc_pp_beta_res_allsector.png");

    }

    public void viewResPPionHipoOut(){
