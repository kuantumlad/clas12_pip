...
public class DCFiducialCutR1Positive implements BIParticleCandidate{
	...
	if( sec >= 0 ){
	    ...
	    double radius2_DCr1 = Math.pow(25,2) - Math.pow(y1_rot,2);    // cut out the inner circle //32 -> 31 temp mod
